...
async function checkIsYarnV2or3(dir) {
    try {
        ...
        if (yarnRcExists) {
            ...
            const yarnPath = lodash_1.default.get(data, 'yarnPath');
            if (typeof yarnPath === 'string') {
                return yarnPath === '.yarn/releases/yarn-berry.cjs' || yarnPath.startsWith('.yarn/releases/yarn-3.');
            }
        }
    }
    catch (err) {
