...
function getModelsByQuery(query, models) {
    ...
    const modelMatchGroups = lodash_1.default.reduce(models, (modelGroups, model) => {
        ...
        else if (objectType && modelTypeKeyPath && lodash_1.default.has(model, modelTypeKeyPath)) {
    ...
    const typeMatchedModels = modelTypeKeyPath
        ? lodash_1.default.filter(modelMatchGroups.byType, (model) => {
