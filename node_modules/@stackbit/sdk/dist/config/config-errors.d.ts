...
export declare const STACKBIT_CONFIG_NOT_FOUND = "stackbit.yaml or stackbit.config.js was not found, please refer to Stackbit documentation: https://docs.stackbit.com/reference/config";
