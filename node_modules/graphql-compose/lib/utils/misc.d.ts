...
export declare function mapEachKey<NewV = any, T extends object | undefined = object>(obj: T, callback: (value: NonNullable<T>[keyof NonNullable<T>], key: keyof NonNullable<T>) => NewV): T extends undefined ? undefined : ObjMap<NewV>;
